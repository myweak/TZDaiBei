...
typedef void (^FilterBlock)(BOOL isFilter, NSArray *dataSource1Ary,NSArray *dataSource2Ary, NSArray *dataSource3Ary , NSArray *dataSource4Ary);
...
@property (nonatomic,strong) NSArray *dataAry4;
@property (strong,nonatomic)TZProductScreenConditionDateModel *condiTionListModel; // 第四个 筛选按钮数据
// 金额输入 View
@property (nonatomic, strong) TZConditionMoneyView *filterTableView3;
...
// 点击二级选择的数据
@property (nonatomic, copy) void (^backLeverTwoArrTapAction)(NSInteger index);

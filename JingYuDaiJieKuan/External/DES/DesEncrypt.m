...
#import "DesEncrypt.h"
#import "GTMBase64.h"
#define DES_KEY "1234567812345678abcdefghabcdefgh"
...
{
    return encryptWithKeyAndType(text, kCCEncrypt, DES_KEY);
}

static const char* decryptText(const char *text)
{
    return encryptWithKeyAndType(text, kCCDecrypt, DES_KEY);
}

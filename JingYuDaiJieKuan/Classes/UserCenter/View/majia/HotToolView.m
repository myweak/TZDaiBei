...
@interface HotToolView ()<UICollectionViewDelegate, UICollectionViewDataSource>
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        CGFloat width = ([UIScreen mainScreen].bounds.size.width - 24) / 4;
        layout.itemSize = CGSizeMake(width, 46);
        ...
        [_collectionView registerClass:[RootCollectionCell class] forCellWithReuseIdentifier:@"RootCollectionCell"];

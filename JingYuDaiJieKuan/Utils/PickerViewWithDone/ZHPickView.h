...
@optional
-(void)toobarDonBtnHaveClick:(ZHPickView *)pickView resultString:(NSString *)resultString bankid:(NSString *)bankid;
...
@property (nonatomic, copy)RemoveBlock m_removeBlock;
